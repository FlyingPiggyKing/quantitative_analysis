...
**Note**: The dragon-tiger-list endpoint now joins `pe_ttm` and `total_mv` from this capability onto each DragonTigerItem. No behavior change to this requirement itself — it continues to provide the same data.
