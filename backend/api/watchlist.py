...
async def get_watchlist(
    ...
    return WatchlistService.get_watchlist(user_id=current_user["user_id"], page=page, page_size=page_size)
...
async def add_to_watchlist(
    ...
    result = WatchlistService.add_stock(current_user["user_id"], request.symbol, request.name)
    if "error" in result:
